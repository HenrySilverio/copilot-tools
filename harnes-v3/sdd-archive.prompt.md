---
agent: agent
# Operacao mecanica e barata. Um modelo pequeno da conta; nao gaste modelo caro aqui.
# CONFIRMAR a grafia do modelo e das ferramentas.
model: Claude Haiku 4.5 (copilot)
tools: ['readFile', 'editFiles', 'execute']
